...
# BOTS_AND_TEST_MESSAGE["PythonAgentEx"] = ProtocolMessage(
#     role="user", content="Draw USA map."
# )

# BOTS_AND_TEST_MESSAGE["ResumeReview"] = ProtocolMessage(
#     role="user", content="Draw USA map."
# )

BOTS_AND_TEST_MESSAGE["RunPythonCode"] = ProtocolMessage(
